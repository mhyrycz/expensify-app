...
const addOne = store.dispatch(addExpense({ description: 'Rent', amount: 100, createdAt: 300 }));
const addSecond = store.dispatch(addExpense({ description: 'Coffee', amount: 300, createdAt: 100 }));
//
